...
public class CountryCodePicker extends RelativeLayout {
    ...
    View.OnClickListener countryCodeHolderClickListener = new View.OnClickListener() {
        ...
        public void onClick(View v) {
            if (isCcpClickable()) {
                launchCountrySelectionDialog(selectCountryLabel, searchHintLabel, nodataFound);
            }
        }
    };


    public void setLabel(String selectCountryLabel, String searchHintLabel, String nodataFound) {
    ...
    private void init(AttributeSet attrs) {
        ...
        //textView_selectedCountry.setTypeface(ResourcesCompat.getFont(context, R.font.gteestidisplayregular));
    ...
    public void setTextColor(int colorCode) {
        textView_selectedCountry.setTextColor(ContextCompat.getColor(getContext(), colorCode));
    }
     ...
     */
    public void launchCountrySelectionDialog(String selectCountryLabel, String searchHint, String nodataFound) {
        CountryCodeDialog.openCountryCodeDialog(codePicker, selectCountryLabel, searchHint, nodataFound);
    }
