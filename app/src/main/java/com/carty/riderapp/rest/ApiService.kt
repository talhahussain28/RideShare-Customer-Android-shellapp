package com.carty.riderapp.rest
...
import com.carty.riderapp.ui.home.faq.response.FaqListApiResponse
import com.carty.riderapp.ui.home.faq.response.FaqSubListApiResponse
...
interface ApiService {
   ...
   /* @FormUrlEncoded
    ...
    fun signInAPINew(
        @Field(parameters.password) password: String,
        @Field(parameters.mobile_country_code) mobile_country_codes: String,
        @Field(parameters.mobile) mobiles: String,
        @Field(parameters.email) emails: String,
        @Field(parameters.user_type) user_types: String
      ...
      @FormUrlEncoded
       ...
       fun signInAPINew(
           ...
           @Field(parameters.email) emails: String,
           @Field(parameters.user_type) user_types: String
       ): Observable<retrofit2.Response<LoginApiResponse>>
