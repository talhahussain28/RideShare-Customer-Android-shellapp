...
import com.herride.customer.common.*
...
import com.herride.customer.ui.home.address.SelectAddressFragment
import com.herride.customer.ui.home.driver_details.DriverDetailFragment
import com.herride.customer.ui.home.model.TripStatusTracking
import com.herride.customer.ui.home.notification.NotificationFragment
import com.herride.customer.ui.home.order_place.OrderPlaceFragment
import com.herride.customer.ui.home.order_place.model.DriverLocationModel
...
class HomeFragment : BaseFragment(),
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        edtpickup = homeView!!.findViewById(R.id.edtpickup)
        edtDropoff = homeView!!.findViewById(R.id.edtDropoff)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        edtpickup!!.setSingleLine(true)
        edtpickup!!.ellipsize = TextUtils.TruncateAt.END

        edtDropoff!!.setSingleLine(true)
        ...
        edtpickup!!.setOnClickListener {
            try {
                ...
                frag.setTargetFragment(this@HomeFragment, Constants.ADDRESSPICKUP)
        ...
        edtDropoff!!.setOnClickListener {
            ...
            try {
                var frag = SelectAddressFragment()
                frag.setTargetFragment(this@HomeFragment, Constants.ADDRESSDROPOFF)
                baseActivity!!.addFragment(frag, true)
            } catch (e: Exception) {
                Log.e("Exception Here", "Exception Here")
            }
...
/////--------------------------------------------
    ...
    fun setMarkers() {
        ...
        if (jobStatus.equals(Constants.ACCEPTED, ignoreCase = true) ||
                jobStatus.equals(com.herride.customer.common.Constants.PICKED_UP, ignoreCase = true)) {
