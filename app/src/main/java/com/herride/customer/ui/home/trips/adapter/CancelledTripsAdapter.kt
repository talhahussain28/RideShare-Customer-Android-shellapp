...
public class CancelledTripsAdapter(private var arrayList: MutableList<TripApiResponse.Payload>) :
        RecyclerView.Adapter<CancelledTripsAdapter.ContactViewHolder>() {
